	...
	<center>
		...
		<div align="center">
			<form action="/LibraryManagementSystem/AddUser" method="post"
				...
				<table cellpadding="3">
					...
					<tr>
						...
						<td><input type="text" name="emailID"
							placeholder="Eg:sam@xxx.com" required="required"
				...
				<input type="submit" class="btn" name="adduser" value="Add User" />&nbsp<input
			...
			<c:if test="${not empty op}">
				<h5>
					<font class="success">The book record has been successfully
						<c:out value="${op}" />
					</font>
				</h5>
			</c:if>
