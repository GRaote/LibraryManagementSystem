...
<body>
	...
	<center>
		...
		<br> <br> <br>
		<form name="IssueForm" action="/LibraryManagementSystem/IssueBook"
			method="post">
			Book Copy ID :<input type="text" name="copyID" required="required"
				placeholder="1" pattern="[0-9]+"><br> <br> User
			Email ID :<input type="email" name="emailID"
				placeholder="sam@xxx.com"><br> <br> <br> <input
				type="submit" name="issue" value="ISSUE "
				onclick="return validateEmail()" class="btn"></input>
		</form>
