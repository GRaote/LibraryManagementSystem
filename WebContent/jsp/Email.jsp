...
<body>
	<center>
		...
		<div class="img">
			<br>
			<nav> <a href="/LibraryManagementSystem/jsp/Librarian.jsp">HOME</a>
			<a
			...
			<br> <br>
			<form
				action='/LibraryManagementSystem/Pending?emailID=<c:out value="${emailID}"/>'
				method="post">
				<p class="success">
					<c:out value="${transactionSuccessful}" />
				</p>
